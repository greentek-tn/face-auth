...
class EnterPasswordView extends StatelessWidget {
  ...
  onTap: () async {
    if (_formFieldKey.currentState!.validate()) {
      ...
      // Create a new document with a random ID in the "password" collection
      DocumentReference docRef = FirebaseFirestore.instance.collection("password").doc();
      await docRef.set({"password": enteredPassword});
      
      // Navigate to the RegisterFaceView
